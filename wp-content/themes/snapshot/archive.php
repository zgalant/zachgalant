...
<div id="content" class="fullspan">
	...
	<div class="container_16 clearfix fullspan">
         ...
         <div class="grid_6 <?php if ($counter == 1) { echo 'alpha'; } else { echo 'omega'; $counter = 0; } ?>">	
			...
			<div class="post">
				...
				<div class="theme">
		            ...
		            <?php if (get_post_meta($post->ID, "link", $single = true)) { ?>
    		      	    <div class="grid_4 alpha"><h2><a title="<?php the_title(); ?>" href="<?php echo get_post_meta($post->ID, "link", $single = true); ?>" rel="bookmark"><?php the_title(); ?></a></h2></div>
    		      	<?php } else { ?>
		      	...
		      	<div style="clear:both;"></div>	
		      	<?php if (get_post_meta($post->ID, "link", $single = true)) { ?>
		      	    <div><a href="<?php echo get_post_meta($post->ID, "link", $single = true); ?>"><p><?php the_excerpt() ?></p></a></div>
		      	<?php } else { ?>
